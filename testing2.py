            ...
            if self._bodies is not None:
                for i in range(0, self._kinect.max_body_count):
                    ...
                    if saveFrame and frameNumberRead % 25==0:
                        ...
                        framesave = frame2[tiprx-100:wristrx+100,tipry-100:wristry+100]
                        sFrame = cv2.resize(framesave, (200, 200)) # resize to 100 x 100 to save
                        # sFrame = cv2.resize(final, (100, 100)) # resize to 100 x 100 to save
                        cv2.imwrite("output/frame-"+str(frameNumber)+".png", sFrame)
